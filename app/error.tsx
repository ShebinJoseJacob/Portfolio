  ...
  return (
    <div className="min-h-screen bg-primary-950 flex items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center">
        <h1 className="text-6xl md:text-8xl font-bold text-accent-orange mb-4">Oops!</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="/"
            className="bg-primary-800 hover:bg-primary-700 text-white px-6 py-3 rounded-lg font-medium transition-all hover:scale-[1.02] border border-primary-600"
          >
            Go Home
          </Link>
        </div>
